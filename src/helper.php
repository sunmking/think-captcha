...
use Sunmking\Captcha\facade\Captcha;
 ...
 */
function captcha($config = null,bool $api = false): Response
{
 ...
 * @return bool
 */
function captcha_check($value,$uuid)
{
    return Captcha::check($value,$uuid);
}
